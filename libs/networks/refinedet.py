...
class RefineDet(nn.Module):
    ...
    def forward(self, x, targets=None):
        ...
        #removed class tuples since AIMET doesnot support
        self.arm_predictions = self._forward_arm_head(forward_features)
        self.odm_predictions = self._forward_odm_head(pyramid_features)
